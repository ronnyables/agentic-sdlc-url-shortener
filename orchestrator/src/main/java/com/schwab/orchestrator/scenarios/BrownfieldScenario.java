 ...
 * regression caught by actually running `mvn test` (the RegressionFixtureIT
...
public final class BrownfieldScenario {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // Deliberately include the fault-injection fixture alongside a real, passing test class so the
        // scenario exercises a genuine (simulated) regression rather than an always-green demo.
        // RegressionFixtureIT only runs when named explicitly like this - see its javadoc.
        opts.testClassNames = List.of("UrlShortenerServiceTest", "RegressionFixtureIT");
